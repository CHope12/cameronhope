...
const Page = () => {
  return (
    <>
    <BackButton />
    <div className="flex h-full py-6 items-center justify-center gap-12 pt-28 flex-wrap">
      {
    ...
    <div className="flex flex-col pt-6 px-4 justify-center items-center">
      <p className="text-lg text-gray-300 pb-5 text-center">
